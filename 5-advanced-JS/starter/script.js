...
var john ={
    ...
    presentation: function(style,timeOfDay){
       if(style === 'formal'){
           ...
           console.log('Hey! What\'s up? I\'m '+this.name+', I\'m a '+ this.job +' and I\'m '+this.age+' years old '+ timeOfDay+'.');
       }
    }
};
...
(function(){
    ...
    var q1= new Question('Is the java script the collest programming language in the world?',
    ['Yes','No'],
    0);
